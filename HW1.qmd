...
Does it ensure no duplicates in cards across hands? What happens if you ask for more than 10 hands to be dealt? 
Yes, it ensure no duplicates in cards across hands as we mentioned above, and if the number of players > 10, there would have a warning message "Too many players for a single deck!".
